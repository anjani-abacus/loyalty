...
const getColumns = ({handleEdit = () => {}, handleDelete = () => { } ,limit, page}) => [
    ...
    {
        accessorKey: "contractor_point",
        header: "Contractor Point",
        filterType: "text",
        cell: ({ row }) => row.original?.contractor_point || "---",
    },
    {
        accessorKey: "painter_point",
        header: "Painter Point",
        filterType: "text",
        cell: ({ row }) => row.original?.painter_point || "---",
    },
    {  
    accessorKey: "action",
    header: "Action",
