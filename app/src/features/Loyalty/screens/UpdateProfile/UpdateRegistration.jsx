...
const UpdateRegistration = () => {
    ...
    const submit = async (value) => {
        try {
            ...
            if (result.statusCode === 200) {
                Toast.show({ type: 'success', text1: t(result.statusMsg), visibilityTime: 6000 });
                ...
                Toast.show({ type: 'error', text1: t(result.statusMsg), visibilityTime: 6000 });
            ...
            setButtonDisable(false);
            setButtonLoading(false);
            Toast.show({ type: 'error', text1: error.message || 'An unexpected error occurred', visibilityTime: 6000 });
    ...
    const generateDynamicSchema = () => {
        ...
        if (count > 0) {
            Toast.show({ type: 'error', text1: 'Please Fill Additional Information Data Also', visibilityTime: 6000 });
            return true;
        } else {
            return false;
        }
