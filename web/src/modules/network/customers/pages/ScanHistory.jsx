...
import { getLedgerColumns, getScanColumns } from "../Columns";

import { useInfluencers, useScanHistoryList, useUpdateInfluencer, useUpdateLoginStatus, useUpdateTypeChange } from "../useData";
import TableSkeleton from "../../../../skeleton/tableSkeleton";

// import {  useQueryClient } from "@tanstack/react-query";

const ScanHistory = ({influencerId}) => {
    ...
    const { scanHistoryData, isLoading, refetch, isFetching } = useScanHistoryList(influencerId);
    ...
    return (
        <>
                <DataTable
                    ...
                    userData={scanHistoryData || []}
                    setFilter={setFilter}
                    renderSkeleton={() => <TableSkeleton columns={getScanColumns({})} rows={limit} />}
                    columns={getScanColumns({ selectedType, setSelectedType, handleTypeChange, handleStatusChange, limit, page })}
