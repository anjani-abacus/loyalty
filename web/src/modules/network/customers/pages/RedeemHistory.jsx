...
import { getRedeemHistoryColumns } from "../Columns";

import { useInfluencers, useRedeemHistoryList, useUpdateInfluencer, useUpdateLoginStatus, useUpdateTypeChange } from "../useData";
import TableSkeleton from "../../../../skeleton/tableSkeleton";

// import {  useQueryClient } from "@tanstack/react-query";

const RedeemHistory = ({influencerId}) => {
    ...
    const { redeemHistoryData, isLoading, refetch, isFetching } = useRedeemHistoryList(influencerId);
    ...
    return (
        <>
                <DataTable
                    ...
                    userData={redeemHistoryData || []}
                    setFilter={setFilter}
                    renderSkeleton={() => <TableSkeleton columns={getRedeemHistoryColumns({})} rows={limit} />}
                    columns={getRedeemHistoryColumns({ selectedType, setSelectedType, handleTypeChange, handleStatusChange, limit, page })}
