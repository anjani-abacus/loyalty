...
import { useDetail, useUpdateInfluencer, useUpdateKycStatus, useUpdateProfileStatus } from "../useData";
...
const CustomerDetail = () => {
  ...
  const { detail, basicDetail, documentDetail, dealerDetail, isLoading, currentStatus, refetch: refetchDetails } =
    useDetail(params?.id);
        ...
        {tabValue == 'BASIC DETAIL' &&
          <div className="flex flex-1 gap-2 p-4 pt-0">
            <div className="flex-1 flex flex-col gap-6">
              <DetailBlock params={params} refetchDetails={refetchDetails} title="Basic Detail" data={basicDetail} isLoading={isLoading} extraAction={<EditButton initialData={detail} />} />
          ...
          /> */}
            ...
            {/* Right: Logs */}
            {/* <div className="w-[300px] p-4 bg-background border rounded-lg shadow-xs">
